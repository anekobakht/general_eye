...
namespace general_cheshm.Controllers
{
    ...
    public class neversController : Controller
    {
        ...
        public neversController(general_cheshmContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var q = _context.v_never.ToList();
              return _context.v_never != null ? 
                          ...
                          Problem("Entity set 'general_cheshmContext.never'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'general_cheshmContext.never'  is null.");
            }
            var never = await _context.never.FindAsync(id);
            if (never != null)
            {
